...
namespace LCD1IN8{
   ...
   //% blockId=DrawPoint
    //% blockGap=8
    //% block="画点|x %x|y %y|颜色 %Color|点的大小 %Dot"
    ...
    //% blockGap=8
    //% block="画长方形|X起点 %Xstart2|Y起点 %Ystart2|X终点 %Xend2|Y终点 %Yend2|颜色 %Color|填充 %Filled |线宽 %Dot_Pixel"
    ...
    //% blockId=DisString
    //% blockGap=8
    //% block="显示字符串|X %Xchar|Y %Ychar|文本 %ch|颜色 %Color"
